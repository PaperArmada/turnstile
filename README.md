...
- **18 MCP tools** for starting, transitioning, signalling, dispatching, and inspecting process instances.
...
- [Acceptance verification](docs/verification.md) — wiring `turnstile verify` into CI as a required check
